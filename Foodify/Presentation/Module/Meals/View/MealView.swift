...
fileprivate extension MealView {
  func setView(presenter: MealPresenter) {
  ...
  func render(presenter: MealPresenter) {
...
extension MealView: UITableViewDelegate, UITableViewDataSource {
